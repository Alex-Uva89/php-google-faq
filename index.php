...
<header>
    <div class="container_head">
        ...
        <img src="https://www.igizmo.it/wp-content/uploads/2020/01/google_logo-696x265.png" alt="google logo">
    ...
    <div class="container">
        ...
        $faq = [
            ...
            [
                ...
                <ol>
                <li class="item2">Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
                <li class="item2">Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li>
                </ol>
                </li>
                <li class="item1">La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li>
                </ol>
